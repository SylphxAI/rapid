 ...
 *
 * CRITICAL: Import from @rapid/tui to use same module instance as List component
 */
import { computed, createRoot, signal } from '@rapid/runtime';
import { List } from './List.js';

// CRITICAL: Import from @rapid/tui to share the same inputHandlers instance
import {
  Box,
  FocusProvider,
  clearInputHandlers,
