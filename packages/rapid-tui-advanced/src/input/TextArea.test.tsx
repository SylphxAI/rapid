 ...
 *
 * CRITICAL: Import from @rapid/tui to use same module instance as TextArea component
 */
import { createRoot, signal } from '@rapid/runtime';
import { TextArea } from './TextArea.js';

import { clearInputHandlers, dispatchInput, setPlatformOps, tuiPlatformOps } from '@rapid/tui';
