/**
 * TUIRenderer Orchestrator
 *
 * Owns the complete lifecycle of a TUI application:
 * - Terminal setup (raw mode, cursor, alternate screen)
 * - Component tree creation and Yoga layout computation
 * - Render loop with FPS throttling and double-buffer diff
 * - Input handling (keyboard, mouse) and console interception
 * - Cleanup on exit
 *
...
import { forceDisableMouse } from './mouse-registration.js';
import { findStaticNodes, processStaticNodes } from './static-content.js';
