...
import zenCompiler from '@zen/compiler/vite';

export default defineConfig({
  plugins: [zenCompiler()],
  esbuild: {
    jsx: 'automatic',
    jsxImportSource: '@zen/web', // or @zen/native, @zen/tui
  },
});
```
...
It transforms JSX at build time to make lazy evaluation automatic, then your chosen renderer (@zen/web, @zen/native, @zen/tui) handles the actual rendering.
