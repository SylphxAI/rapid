...
import { computed, disposeNode, onCleanup, onMount } from '@rapid/signal';
import type { TUINode } from '@rapid/tui';
import { appendChild } from '@rapid/tui/jsx-runtime';
...
/**
 * Router component - Client-side routing for TUI powered by @rapid/router-core
 *
