# Zen v3.6.0 Performance Analysis

## Executive Summary

Zen v3.6.0 實現了兩項關鍵優化：
...
**建議**: 升級到 v3.6！除非你對 130 bytes 極度敏感。
...
// Type additions
type ZenCore<T> = {
  _version: number; // ✅ v3.6
  // ...
};

type ComputedCore<T> = {
  _sourceVersions?: number[]; // ✅ v3.6
  // ...
};
...
// Type additions
type ZenCore<T> = {
  _computedSlots?: number[]; // ✅ v3.6
  // ...
};

type ComputedCore<T> = {
  _sourceSlots?: number[]; // ✅ v3.6
  // ...
};
